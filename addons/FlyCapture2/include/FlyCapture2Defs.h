...
//=============================================================================
// $Id: FlyCapture2Defs.h 135122 2011-11-30 19:59:55Z mgara $
//=============================================================================
...
namespace FlyCapture2
{
    ...
    {        
        ...
        NUM_PIXEL_FORMATS	   =  19, /**< Number of pixel formats. */
    ...
    struct GigEConfig
    {
        ...
        GigEConfig()
        {
			...
			timeoutForPacketResend = 1000;
			maxPacketsToResend = 20;
            registerTimeoutRetries = 3;
            registerTimeout = 100000;
        }
    };
